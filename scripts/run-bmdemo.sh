...
echo "  • current_stage  - Progress indicator (set-netboot, repave, etc.)"
echo ""
echo "Design decision: Plans/steps are INTERNAL - SDK sees only operation type + phase."
echo ""
...
echo "  ✓ Internal workflow engine: plans/steps hidden from SDK"
echo ""
echo "API design:"
echo ""
...
echo "  • Plans/Steps are INTERNAL Go types - not in proto/SDK"
echo "  • Clients see: type, phase, current_stage, error (never step list)"
echo ""
